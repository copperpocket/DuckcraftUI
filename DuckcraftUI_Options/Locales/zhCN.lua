...
local L = LibStub("AceLocale-3.0"):NewLocale("DuckcraftUI_Options", "zhCN")
...
L["Open DuckcraftUI Settings"] = "打开DuckcraftUI设置"
L["Open the DuckcraftUI configuration panel."] = "打开DuckcraftUI配置面板。"
L["Use /duckcraftui to open the full settings panel."] = "输入 /duckcraftui 以打开完整设置面板。"
...
L["Commands: /duckcraftui, /dui, /pi — /duckcraftui edit (editor) — /duckcraftui help"] = "命令：/duckcraftui, /dui, /pi — /duckcraftui edit (编辑) — /duckcraftui help"
L["GitHub (select and Ctrl+C to copy):"] = "GitHub (选中后按Ctrl+C复制)："
L["All"] = "全部"
L["Error:"] = "错误："
L["Error: DuckcraftUI addon not found!"] = "错误：未找到DuckcraftUI插件！"
...
L["Enable or disable specific DuckcraftUI modules"] = "启用或禁用特定的DuckcraftUI模块"
...
-- 模块开关描述
L["Enable DuckcraftUI player castbar. When disabled, shows default Blizzard castbar."] = "启用DuckcraftUI玩家施法条。禁用时，显示默认的暴雪施法条。"
L["Enable DuckcraftUI player castbar styling."] = "启用DuckcraftUI玩家施法条样式。"
L["Enable DuckcraftUI target castbar. When disabled, shows default Blizzard castbar."] = "启用DuckcraftUI目标施法条。禁用时，显示默认的暴雪施法条。"
L["Enable DuckcraftUI target castbar styling."] = "启用DuckcraftUI目标施法条样式。"
L["Enable DuckcraftUI focus castbar. When disabled, shows default Blizzard castbar."] = "启用DuckcraftUI焦点施法条。禁用时，显示默认的暴雪施法条。"
L["Enable DuckcraftUI focus castbar styling."] = "启用DuckcraftUI焦点施法条样式。"
L["Enable the complete DuckcraftUI action bars system. This controls: Main action bars, vehicle interface, stance/shapeshift bars, pet action bars, multicast bars (totems/possess), button styling, and hide Blizzard elements. When disabled, all action bar related features will use default Blizzard interface."] = "启用完整的DuckcraftUI动作条系统。控制内容包括：主动作条、载具界面、姿态/变形条、宠物动作条、多目标条（图腾/控制）、按钮样式，以及隐藏暴雪元素。禁用时，所有动作条相关功能将使用默认的暴雪界面。"
...
L["Apply DuckcraftUI micro menu and bags system styling and positioning. Includes character button, spellbook, talents, etc. and bag management. When disabled, these elements will use default Blizzard positioning and styling."] = "应用DuckcraftUI微型菜单和背包系统的样式和位置。包括角色按钮、法术书、天赋等以及背包管理。禁用时，这些元素将使用默认的暴雪位置和样式。"
...
L["Enable DuckcraftUI minimap enhancements including custom styling, positioning, tracking icons, and calendar. When disabled, uses default Blizzard minimap appearance and positioning."] = "启用DuckcraftUI小地图增强功能，包括自定义样式、位置、追踪图标和日历。禁用时，使用默认的暴雪小地图外观和位置。"
L["Minimap styling, tracking icons, and calendar."] = "小地图样式、追踪图标和日历。"
L["Enable DuckcraftUI buff frame with custom styling, positioning, and toggle button functionality. When disabled, uses default Blizzard buff frame appearance and positioning."] = "启用具有自定义样式、位置和切换按钮功能的DuckcraftUI增益效果框体。禁用时，使用默认的暴雪增益效果框体外觀和位置。"
...
L["DuckcraftUI quest tracker positioning and styling."] = "DuckcraftUI任务追踪器的位置和样式设置。"
...
L["Dark"] = "\u6697\u8272"
L["DuckcraftUI Style"] = "DuckcraftUI \u6837\u5f0f"
L["Midnight"] = "\u5b50\u5915"
...
L["TIP: Use Editor Mode to position the totem bar (type /duckcraftui edit)."] = "提示：使用编辑模式来定位图腾条（输入 /duckcraftui edit）。"
...
L["Apply DuckcraftUI border styling to addon icons (e.g., bag addons)"] = "为插件图标（例如背包插件）应用DuckcraftUI边框样式"
L["Apply DuckcraftUI border styling to addon icons."] = "为插件图标应用DuckcraftUI边框样式。"
...
L["Use new DuckcraftUI object icons on the minimap. When disabled, uses classic Blizzard icons."] = "在小地图上使用新的DuckcraftUI对象图标。禁用时，使用经典的暴雪图标。"
...
L["Use DuckcraftUI alternative class icons instead of Blizzard's class icon atlas."] = "使用 DuckcraftUI 的替代职业图标，而不是 Blizzard 的职业图标图集。"
...
L["DuckcraftUI (Default)"] = "DuckcraftUI（默认）"
...
L["Follows the Target frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "默认跟随目标框架。在编辑模式（/duckcraftui edit）中移动它可使其分离并自由定位。"
...
L["Follows the Focus frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "默认跟随焦点框架。在编辑模式（/duckcraftui edit）中移动它可使其分离并自由定位。"
...
L["Not a valid DuckcraftUI preset string."] = "不是有效的 DuckcraftUI 预设字符串。"
