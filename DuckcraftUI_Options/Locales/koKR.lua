...
local L = LibStub("AceLocale-3.0"):NewLocale("DuckcraftUI_Options", "koKR")
...
L["Open DuckcraftUI Settings"] = "DuckcraftUI 설정 열기"
L["Open the DuckcraftUI configuration panel."] = "DuckcraftUI 설정 패널 열기"
L["Use /duckcraftui to open the full settings panel."] = "/duckcraftui 입력 시 전체 설정 패널 열기"
...
L["Commands: /duckcraftui, /dui, /pi — /duckcraftui edit (editor) — /duckcraftui help"] = "명령어: /duckcraftui, /dui, /pi — /duckcraftui edit (편집) — /duckcraftui help"
L["GitHub (select and Ctrl+C to copy):"] = "GitHub (선택 후 Ctrl+C로 복사):"
L["All"] = "전체"
L["Error:"] = "오류:"
L["Error: DuckcraftUI addon not found!"] = "오류: DuckcraftUI 애드온을 찾을 수 없습니다!"
...
L["Enable or disable specific DuckcraftUI modules"] = "특정 DuckcraftUI 모듈을 활성화 또는 비활성화합니다"
...
L["Enable DuckcraftUI player castbar. When disabled, shows default Blizzard castbar."] = "DuckcraftUI 플레이어 시전 바를 활성화합니다. 비활성화 시 블리자드 기본 시전 바가 표시됩니다."
L["Enable DuckcraftUI player castbar styling."] = "DuckcraftUI 플레이어 시전바 스타일 적용"
L["Enable DuckcraftUI target castbar. When disabled, shows default Blizzard castbar."] = "DuckcraftUI 대상 시전 바를 활성화합니다. 비활성화 시 블리자드 기본 시전 바가 표시됩니다."
L["Enable DuckcraftUI target castbar styling."] = "DuckcraftUI 대상 시전바 스타일 적용"
L["Enable DuckcraftUI focus castbar. When disabled, shows default Blizzard castbar."] = "DuckcraftUI 주시 대상 시전 바를 활성화합니다. 비활성화 시 블리자드 기본 시전 바가 표시됩니다."
L["Enable DuckcraftUI focus castbar styling."] = "DuckcraftUI 주시 대상 시전바 스타일 적용"
L["Enable the complete DuckcraftUI action bars system. This controls: Main action bars, vehicle interface, stance/shapeshift bars, pet action bars, multicast bars (totems/possess), button styling, and hide Blizzard elements. When disabled, all action bar related features will use default Blizzard interface."] = "DuckcraftUI 단축바 시스템 전체를 활성화합니다. 제어 대상: 주 단축바, 탈것 인터페이스, 태세/변신 바, 소환수 단축바, 멀티캐스트 바(토템/빙의), 버튼 스타일, 블리자드 요소 숨기기. 비활성화 시 모든 단축바 관련 기능이 블리자드 기본 인터페이스를 사용합니다."
...
L["Apply DuckcraftUI micro menu and bags system styling and positioning. Includes character button, spellbook, talents, etc. and bag management. When disabled, these elements will use default Blizzard positioning and styling."] = "DuckcraftUI 마이크로 메뉴 및 가방 시스템 스타일과 위치를 적용합니다. 캐릭터 버튼, 주문서, 특성 등과 가방 관리를 포함합니다. 비활성화 시 블리자드 기본 위치와 스타일이 사용됩니다."
...
L["Enable DuckcraftUI minimap enhancements including custom styling, positioning, tracking icons, and calendar. When disabled, uses default Blizzard minimap appearance and positioning."] = "사용자 지정 스타일, 위치, 추적 아이콘, 달력을 포함한 DuckcraftUI 미니맵 개선 기능을 활성화합니다. 비활성화 시 블리자드 기본 미니맵 외관과 위치를 사용합니다."
L["Minimap styling, tracking icons, and calendar."] = "미니맵 스타일, 추적 아이콘 및 달력"
L["Enable DuckcraftUI buff frame with custom styling, positioning, and toggle button functionality. When disabled, uses default Blizzard buff frame appearance and positioning."] = "사용자 지정 스타일, 위치 및 전환 버튼 기능이 포함된 DuckcraftUI 버프 프레임을 활성화합니다. 비활성화 시 블리자드 기본 버프 프레임 외관과 위치를 사용합니다."
...
L["DuckcraftUI quest tracker positioning and styling."] = "DuckcraftUI 퀘스트 추적기 위치 및 스타일 설정."
...
L["Dark"] = "\uc5b4\ub450\uc6b4"
L["DuckcraftUI Style"] = "DuckcraftUI \uc2a4\ud0c0\uc77c"
L["Midnight"] = "\uc790\uc815"
...
L["TIP: Use Editor Mode to position the totem bar (type /duckcraftui edit)."] = "팁: 편집 모드에서 토템 바의 위치를 조정하세요 (/duckcraftui edit 입력)."
...
L["Apply DuckcraftUI border styling to addon icons (e.g., bag addons)"] = "애드온 아이콘에 DuckcraftUI 테두리 스타일을 적용합니다 (예: 가방 애드온)"
L["Apply DuckcraftUI border styling to addon icons."] = "애드온 아이콘에 DuckcraftUI 테두리 스타일 적용"
...
L["Use new DuckcraftUI object icons on the minimap. When disabled, uses classic Blizzard icons."] = "미니맵에 새로운 DuckcraftUI 오브젝트 아이콘을 사용합니다. 비활성화 시 클래식 블리자드 아이콘을 사용합니다."
...
L["Use DuckcraftUI alternative class icons instead of Blizzard's class icon atlas."] = "블리자드 직업 아이콘 아틀라스 대신 DuckcraftUI 대체 직업 아이콘을 사용합니다."
...
L["DuckcraftUI (Default)"] = "DuckcraftUI (기본값)"
...
L["Follows the Target frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "기본적으로 대상 프레임을 따라다닙니다. 편집 모드(/duckcraftui edit)에서 이동하면 분리되어 자유롭게 배치할 수 있습니다."
...
L["Follows the Focus frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "기본적으로 주시 대상 프레임을 따라다닙니다. 편집 모드(/duckcraftui edit)에서 이동하면 분리되어 자유롭게 배치할 수 있습니다."
...
L["Not a valid DuckcraftUI preset string."] = "유효한 DuckcraftUI 프리셋 문자열이 아닙니다."
