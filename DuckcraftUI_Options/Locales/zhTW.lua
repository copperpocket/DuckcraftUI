...
local L = LibStub("AceLocale-3.0"):NewLocale("DuckcraftUI_Options", "zhTW")
...
L["Open DuckcraftUI Settings"] = "開啟DuckcraftUI設定"
L["Open the DuckcraftUI configuration panel."] = "開啟DuckcraftUI配置面板。"
L["Use /duckcraftui to open the full settings panel."] = "輸入 /duckcraftui 以開啟完整設定面板。"
...
L["Commands: /duckcraftui, /dui, /pi — /duckcraftui edit (editor) — /duckcraftui help"] = "命令：/duckcraftui, /dui, /pi — /duckcraftui edit (編輯) — /duckcraftui help"
L["GitHub (select and Ctrl+C to copy):"] = "GitHub (選中後按Ctrl+C複製)："
L["All"] = "全部"
L["Error:"] = "錯誤："
L["Error: DuckcraftUI addon not found!"] = "錯誤：未找到DuckcraftUI外掛！"
...
L["Enable or disable specific DuckcraftUI modules"] = "啟用或禁用特定的DuckcraftUI模組"
...
-- 模組開關描述
L["Enable DuckcraftUI player castbar. When disabled, shows default Blizzard castbar."] = "啟用DuckcraftUI玩家施法條。禁用時，顯示預設的暴雪施法條。"
L["Enable DuckcraftUI player castbar styling."] = "啟用DuckcraftUI玩家施法條樣式。"
L["Enable DuckcraftUI target castbar. When disabled, shows default Blizzard castbar."] = "啟用DuckcraftUI目標施法條。禁用時，顯示預設的暴雪施法條。"
L["Enable DuckcraftUI target castbar styling."] = "啟用DuckcraftUI目標施法條樣式。"
L["Enable DuckcraftUI focus castbar. When disabled, shows default Blizzard castbar."] = "啟用DuckcraftUI焦點施法條。禁用時，顯示預設的暴雪施法條。"
L["Enable DuckcraftUI focus castbar styling."] = "啟用DuckcraftUI焦點施法條樣式。"
L["Enable the complete DuckcraftUI action bars system. This controls: Main action bars, vehicle interface, stance/shapeshift bars, pet action bars, multicast bars (totems/possess), button styling, and hide Blizzard elements. When disabled, all action bar related features will use default Blizzard interface."] = "啟用完整的DuckcraftUI動作條系統。控制內容包括：主動作條、載具介面、姿態/變形條、寵物動作條、多目標條（圖騰/控制）、按鈕樣式，以及隱藏暴雪元素。禁用時，所有動作條相關功能將使用預設的暴雪介面。"
...
L["Apply DuckcraftUI micro menu and bags system styling and positioning. Includes character button, spellbook, talents, etc. and bag management. When disabled, these elements will use default Blizzard positioning and styling."] = "應用DuckcraftUI微型選單和揹包系統的樣式和位置。包括角色按鈕、法術書、天賦等以及揹包管理。禁用時，這些元素將使用預設的暴雪位置和樣式。"
...
L["Enable DuckcraftUI minimap enhancements including custom styling, positioning, tracking icons, and calendar. When disabled, uses default Blizzard minimap appearance and positioning."] = "啟用DuckcraftUI小地圖增強功能，包括自定義樣式、位置、追蹤圖示和日曆。禁用時，使用預設的暴雪小地圖外觀和位置。"
L["Minimap styling, tracking icons, and calendar."] = "小地圖樣式、追蹤圖示和日曆。"
L["Enable DuckcraftUI buff frame with custom styling, positioning, and toggle button functionality. When disabled, uses default Blizzard buff frame appearance and positioning."] = "啟用具有自定義樣式、位置和切換按鈕功能的DuckcraftUI增益效果框體。禁用時，使用預設的暴雪增益效果框體外觀和位置。"
...
L["DuckcraftUI quest tracker positioning and styling."] = "DuckcraftUI任務追蹤器的位置和樣式設定。"
...
L["Dark"] = "\u6697\u8272"
L["DuckcraftUI Style"] = "DuckcraftUI \u6a23\u5f0f"
L["Midnight"] = "\u5b50\u591c"
...
L["TIP: Use Editor Mode to position the totem bar (type /duckcraftui edit)."] = "提示：使用編輯模式來定點陣圖騰條（輸入 /duckcraftui edit）。"
...
L["Apply DuckcraftUI border styling to addon icons (e.g., bag addons)"] = "為外掛圖示（例如揹包外掛）應用DuckcraftUI邊框樣式"
L["Apply DuckcraftUI border styling to addon icons."] = "為外掛圖示應用DuckcraftUI邊框樣式。"
...
L["Use new DuckcraftUI object icons on the minimap. When disabled, uses classic Blizzard icons."] = "在小地圖上使用新的DuckcraftUI物件圖示。禁用時，使用經典的暴雪圖示。"
...
L["Use DuckcraftUI alternative class icons instead of Blizzard's class icon atlas."] = "使用 DuckcraftUI 的替代職業圖示，而不是 Blizzard 的職業圖示圖集。"
...
L["DuckcraftUI (Default)"] = "DuckcraftUI（預設）"
...
L["Follows the Target frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "預設跟隨目標框架。在編輯模式（/duckcraftui edit）中移動它可使其分離並自由定位。"
...
L["Follows the Focus frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "預設跟隨焦點框架。在編輯模式（/duckcraftui edit）中移動它可使其分離並自由定位。"
...
L["Not a valid DuckcraftUI preset string."] = "不是有效的 DuckcraftUI 預設字串。"
