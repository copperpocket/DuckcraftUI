...
-- CUSTOM VISIBILITY
L["Enable Custom Visibility"] = "Enable Custom Visibility"
L["Hide By Default"] = "Hide By Default"
L["Show When"] = "Show When"
L["In Combat"] = "In Combat"
L["Target Selected"] = "Target Selected"
L["Health Not Full"] = "Health Not Full"
L["Power Not Full"] = "Power Not Full"
L["Advanced"] = "Advanced"
L["Custom Macro Condition"] = "Custom Macro Condition"
L["Optionally hide the player frame and reveal it only under chosen conditions. When disabled, the frame behaves normally. Uses alpha fading so it is safe in combat."] = "Optionally hide the player frame and reveal it only under chosen conditions. When disabled, the frame behaves normally. Uses alpha fading so it is safe in combat."
L["Master switch. When off, the player frame is always visible as normal."] = "Master switch. When off, the player frame is always visible as normal."
L["Base state is hidden. The conditions below reveal the frame."] = "Base state is hidden. The conditions below reveal the frame."
L["Reveal the frame whenever current health is below maximum."] = "Reveal the frame whenever current health is below maximum."
L["Reveal the frame whenever current mana/power is below maximum."] = "Reveal the frame whenever current mana/power is below maximum."
L["Optional. Native macro conditional syntax, e.g. [combat][@target,exists][mod:shift]. If it resolves, the frame is shown. Leave blank to ignore."] = "Optional. Native macro conditional syntax, e.g. [combat][@target,exists][mod:shift]. If it resolves, the frame is shown. Leave blank to ignore."
L["Mouse Over"] = "Mouse Over"
L["Reveal the player frame while the mouse is over its position."] = "Reveal the player frame while the mouse is over its position."
L["Fade Duration"] = "Fade Duration"
L["Time in seconds used to fade the player frame in or out. Set to 0 for instant visibility changes."] = "Time in seconds used to fade the player frame in or out. Set to 0 for instant visibility changes."
L["Time in seconds used to fade action bars in or out. Set to 0 for instant visibility changes."] = "Time in seconds used to fade action bars in or out. Set to 0 for instant visibility changes."
L["Show with Target"] = "Show with Target"
L["Show the main bar while a target exists."] = "Show the main bar while a target exists."
L["Show When Health Is Not Full"] = "Show When Health Is Not Full"
L["Show the main bar while your health is below maximum."] = "Show the main bar while your health is below maximum."
L["Show When Power Is Not Full"] = "Show When Power Is Not Full"
L["Show the main bar while your mana or power is below maximum."] = "Show the main bar while your mana or power is below maximum."
L["Bag Bar Visibility"] = "Bag Bar Visibility"
L["Show the bag bar only when selected conditions are active. The inventory and bank windows are not affected."] = "Show the bag bar only when selected conditions are active. The inventory and bank windows are not affected."
L["Time in seconds used to fade the bag bar in or out. Set to 0 for instant visibility changes."] = "Time in seconds used to fade the bag bar in or out. Set to 0 for instant visibility changes."
L["Show on Hover"] = true
L["Show in Combat"] = true
L["Experience Bar"] = true
L["Reputation Bar"] = true
L["XP Bar Fade Duration"] = true
L["Reputation Bar Fade Duration"] = true
L["Micro Menu Visibility"] = true
L["Show the micro menu only when selected conditions are active. The bag bar is configured separately."] = true
L["Time in seconds used to fade the micro menu in or out. Set to 0 for instant visibility changes."] = true
L["Minimap Visibility"] = true
L["Show the entire minimap, including the LFG eye and addon buttons, only when selected conditions are active."] = true
L["Reveal the entire minimap while the mouse is over its position."] = true
L["Reveal the entire minimap while in combat."] = true
L["Reveal the entire minimap while a target exists."] = true
L["Reveal the entire minimap while your health is below maximum."] = true
L["Reveal the entire minimap while your mana or power is below maximum."] = true
L["Time in seconds used to fade the entire minimap in or out. Set to 0 for instant visibility changes."] = true
L["Buff Frame Visibility"] = true
L["Show the buff frame only when selected conditions are active. Manual buff collapse remains respected."] = true
L["Time in seconds used to fade the buff frame in or out. Set to 0 for instant visibility changes."] = true
L["Chat Visibility"] = true
L["Show the complete chat area only when selected conditions are active. Existing tab and button fading remains available."] = true
L["Reveal the chat area while the mouse is over a chat frame, tab, button, or edit box."] = true
L["Reveal the chat area while in combat."] = true
L["Reveal the chat area while a target exists."] = true
L["Reveal the chat area while your health is below maximum."] = true
L["Reveal the chat area while your mana or power is below maximum."] = true
L["Chat Fade Duration"] = true
L["Time in seconds used to fade the complete chat area in or out. Set to 0 for instant visibility changes."] = true
L["Chat Fade"] = true
L["Disable Chat Fade"] = true
L["When enabled, chat text never fades out."] = true
L["Time Visible (seconds)"] = true
