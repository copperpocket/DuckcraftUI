...
local L = LibStub("AceLocale-3.0"):NewLocale("DuckcraftUI_Options", "ruRU")
...
L["Open DuckcraftUI Settings"] = "Открыть настройки DuckcraftUI"
L["Open the DuckcraftUI configuration panel."] = "Открыть панель настроек DuckcraftUI."
L["Use /duckcraftui to open the full settings panel."] = "Используйте /duckcraftui для открытия полной панели настроек."
...
L["Commands: /duckcraftui, /dui, /pi — /duckcraftui edit (editor) — /duckcraftui help"] = "Команды: /duckcraftui, /dui, /pi — /duckcraftui edit (редактор) — /duckcraftui help"
L["GitHub (select and Ctrl+C to copy):"] = "GitHub (выделите и Ctrl+C для копирования):"
L["All"] = "Все"
L["Error:"] = "Ошибка:"
L["Error: DuckcraftUI addon not found!"] = "Ошибка: Аддон DuckcraftUI не найден!"
...
L["Enable or disable specific DuckcraftUI modules"] = "Включить или отключить отдельные модули DuckcraftUI"
...
L["Enable DuckcraftUI player castbar. When disabled, shows default Blizzard castbar."] = "Включить полосу заклинаний DuckcraftUI. При отключении показывается стандартная полоса Blizzard."
L["Enable DuckcraftUI player castbar styling."] = "Включить стилизацию полосы заклинаний игрока DuckcraftUI."
L["Enable DuckcraftUI target castbar. When disabled, shows default Blizzard castbar."] = "Включить полосу заклинаний цели DuckcraftUI. При отключении показывается стандартная полоса Blizzard."
L["Enable DuckcraftUI target castbar styling."] = "Включить стилизацию полосы заклинаний цели DuckcraftUI."
L["Enable DuckcraftUI focus castbar. When disabled, shows default Blizzard castbar."] = "Включить полосу заклинаний фокуса DuckcraftUI. При отключении показывается стандартная полоса Blizzard."
L["Enable DuckcraftUI focus castbar styling."] = "Включить стилизацию полосы заклинаний фокуса DuckcraftUI."
L["Enable the complete DuckcraftUI action bars system. This controls: Main action bars, vehicle interface, stance/shapeshift bars, pet action bars, multicast bars (totems/possess), button styling, and hide Blizzard elements. When disabled, all action bar related features will use default Blizzard interface."] = "Включить полную систему панелей действий DuckcraftUI. Управляет: основными панелями, интерфейсом транспорта, панелью стоек/форм, панелью питомца, панелью мультикаста (тотемы/овладение), стилизацией кнопок и скрытием элементов Blizzard. При отключении все функции панелей действий используют стандартный интерфейс Blizzard."
...
L["Apply DuckcraftUI micro menu and bags system styling and positioning. Includes character button, spellbook, talents, etc. and bag management. When disabled, these elements will use default Blizzard positioning and styling."] = "Применить стилизацию и позиционирование микроменю и сумок DuckcraftUI. Включает кнопку персонажа, книгу заклинаний, таланты и т.д. При отключении элементы используют стандартное расположение Blizzard."
...
L["Enable DuckcraftUI minimap enhancements including custom styling, positioning, tracking icons, and calendar. When disabled, uses default Blizzard minimap appearance and positioning."] = "Включить улучшения миникарты DuckcraftUI: стилизация, позиционирование, значки отслеживания и календарь. При отключении используется стандартный вид и расположение миникарты Blizzard."
L["Minimap styling, tracking icons, and calendar."] = "Стилизация миникарты, значки отслеживания и календарь."
L["Enable DuckcraftUI buff frame with custom styling, positioning, and toggle button functionality. When disabled, uses default Blizzard buff frame appearance and positioning."] = "Включить фрейм эффектов DuckcraftUI: стилизация, позиционирование и кнопка переключения. При отключении используется стандартный вид фрейма эффектов Blizzard."
...
L["DuckcraftUI quest tracker positioning and styling."] = "Позиционирование и стилизация трекера заданий DuckcraftUI."
...
L["Dark"] = "Тёмный"
L["DuckcraftUI Style"] = "Стиль DuckcraftUI"
L["Midnight"] = "Полночь"
...
L["TIP: Use Editor Mode to position the totem bar (type /duckcraftui edit)."] = "СОВЕТ: Используйте режим редактора для позиционирования панели тотемов (введите /duckcraftui edit)."
...
L["Apply DuckcraftUI border styling to addon icons (e.g., bag addons)"] = "Применить стилизацию рамок DuckcraftUI к значкам аддонов (например, аддоны сумок)"
L["Apply DuckcraftUI border styling to addon icons."] = "Применить стилизацию рамок DuckcraftUI к значкам аддонов."
...
L["Use new DuckcraftUI object icons on the minimap. When disabled, uses classic Blizzard icons."] = "Использовать новые значки объектов DuckcraftUI на миникарте. При отключении используются классические значки Blizzard."
...
L["Use DuckcraftUI alternative class icons instead of Blizzard's class icon atlas."] = "Использовать альтернативные значки классов DuckcraftUI вместо атласа значков классов Blizzard."
...
L["DuckcraftUI (Default)"] = "DuckcraftUI (По умолчанию)"
...
L["Follows the Target frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "По умолчанию следует за фреймом цели. Переместите в режиме редактора (/duckcraftui edit) для отсоединения и свободного позиционирования."
...
L["Follows the Focus frame by default. Move it in Editor Mode (/duckcraftui edit) to detach and position freely."] = "По умолчанию следует за фреймом фокуса. Переместите в режиме редактора (/duckcraftui edit) для отсоединения и свободного позиционирования."
...
L["Not a valid DuckcraftUI preset string."] = "Не является допустимой строкой шаблона DuckcraftUI."
