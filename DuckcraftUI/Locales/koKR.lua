...
local L = LibStub("AceLocale-3.0"):NewLocale("DuckcraftUI", "koKR")
...
L["Commands: /duckcraftui config, /duckcraftui edit"] = "명령어: /duckcraftui config, /duckcraftui edit"
...
L["Error -- Addon 'DuckcraftUI_Options' not found or is disabled."] = "오류 -- 'DuckcraftUI_Options' 애드온을 찾을 수 없거나 비활성화되어 있습니다."
...
L["=== DuckcraftUI Commands ==="] = "=== DuckcraftUI 명령어 ==="
L["/duckcraftui or /dui - Open configuration"] = "/duckcraftui 또는 /dui - 설정창 열기"
L["/duckcraftui config - Open configuration"] = "/duckcraftui config - 설정창 열기"
L["/duckcraftui edit - Toggle editor mode (move UI elements)"] = "/duckcraftui edit - 편집 모드 전환 (UI 요소 이동)"
L["/duckcraftui reset - Reset all positions to defaults"] = "/duckcraftui reset - 모든 위치를 기본값으로 초기화"
L["/duckcraftui reset <name> - Reset specific mover"] = "/duckcraftui reset <이름> - 특정 요소의 위치 초기화"
L["/duckcraftui status - Show module status"] = "/duckcraftui status - 모듈 상태 표시"
L["/duckcraftui kb - Toggle keybind mode"] = "/duckcraftui kb - 단축키 설정 모드 전환"
L["/duckcraftui version - Show version info"] = "/duckcraftui version - 버전 정보 표시"
L["/duckcraftui help - Show this help"] = "/duckcraftui help - 도움말 표시"
...
L["=== DuckcraftUI Status ==="] = "=== DuckcraftUI 상태 ==="
...
L["DuckcraftUI Version: "] = "DuckcraftUI 버전: "
L["Use /duckcraftui edit to enter edit mode, then right-click frames to reset."] = "/duckcraftui edit를 입력하여 편집 모드로 들어간 뒤, 프레임을 우클릭하면 위치가 초기화됩니다."
...
L["DuckcraftUI: Minimap module restored to Blizzard defaults"] = "DuckcraftUI: 미니맵 모듈이 블리자드 기본값으로 복구되었습니다."
...
L["TargetFrame"] = "대상"
L["FocusFrame"] = "주시 대상"
L["TargetCastbar"] = "대상 시전바"
L["FocusCastbar"] = "주시 대상 시전바"
L["BagsBar"] = "가방"
L["MicroMenu"] = "마이크로 메뉴"
...
L["DuckcraftUI Conflict Warning"] = "DuckcraftUI 충돌 경고"
L["The addon |cFFFFFF00%s|r conflicts with DuckcraftUI."] = "애드온 |cFFFFFF00%s|r 이(가) DuckcraftUI와 충돌합니다."
L["Reason:"] = "원인:"
L["Disable the conflicting addon now?"] = "충돌하는 애드온을 지금 비활성화하시겠습니까?"
L["Keep Both"] = "둘 다 유지"
L["DuckcraftUI - D3D9Ex Warning"] = "DuckcraftUI - D3D9Ex 경고"
L["DuckcraftUI detected that your client is using D3D9Ex."] = "DuckcraftUI가 클라이언트가 D3D9Ex를 사용 중인 것을 감지했습니다."
L["DuckcraftUI's action bar system is not compatible with D3D9Ex."] = "DuckcraftUI의 액션바 시스템은 D3D9Ex와 호환되지 않습니다."
L["Some DuckcraftUI action bar textures will be missing while this mode is active."] = "이 모드가 활성화된 동안 일부 DuckcraftUI 액션바 텍스처가 보이지 않습니다."
...
L["Understood"] = "확인"
L["DuckcraftUI - UnitFrameLayers Detected"] = "DuckcraftUI - UnitFrameLayers 감지됨"
L["DuckcraftUI already includes Unit Frame Layers functionality (heal prediction, absorb shields, and animated health loss)."] = "DuckcraftUI에는 이미 Unit Frame Layers 기능(치유 예측, 흡수 보호막, 애니메이션 체력 손실)이 포함되어 있습니다."
L["Choose how to resolve this overlap:"] = "이 중복을 해결할 방법을 선택하세요:"
L["Use DuckcraftUI: disable external UnitFrameLayers and enable DuckcraftUI layers."] = "DuckcraftUI 사용: 외부 UnitFrameLayers를 끄고 DuckcraftUI 레이어를 켭니다."
L["Disable Both: disable external UnitFrameLayers and keep DuckcraftUI layers disabled."] = "둘 다 비활성화: 외부 UnitFrameLayers를 끄고 DuckcraftUI 레이어도 끈 상태로 유지합니다."
L["Use DuckcraftUI"] = "DuckcraftUI 사용"
L["Disable Both"] = "둘 다 비활성화"
L["Use DuckcraftUI Unit Frame Layers"] = "DuckcraftUI Unit Frame Layers 사용"
...
-- Conflict reasons
L["Conflicts with DuckcraftUI's custom unit frame textures and power bar system."] = "DuckcraftUI의 사용자 지정 유닛 프레임 텍스처 및 자원 바 시스템과 충돌합니다."
L["Known taint issues when manipulating party frames during combat. DuckcraftUI provides automatic fixes."] = "전투 중 파티 프레임 조작 시 알려진 오염 문제가 있습니다. DuckcraftUI가 자동 수정 기능을 제공합니다."
L["Resets minimap mask and blip textures. DuckcraftUI re-applies its custom textures automatically."] = "미니맵 마스크와 블립 텍스처를 초기화합니다. DuckcraftUI가 사용자 지정 텍스처를 자동으로 다시 적용합니다."
L["SexyMap modifies the minimap borders, shape, and zone text which conflicts with DuckcraftUI's minimap module."] = "SexyMap이 미니맵 테두리, 모양, 지역 이름 텍스트를 변경하여 DuckcraftUI의 미니맵 모듈과 충돌합니다."

-- SexyMap compatibility popup
L["DuckcraftUI - SexyMap Detected"] = "DuckcraftUI - SexyMap 감지됨"
...
L["Choose how DuckcraftUI and SexyMap share the minimap."] = "DuckcraftUI와 SexyMap이 미니맵을 어떻게 함께 사용할지 선택하세요."
L["Requires UI reload to apply."] = "적용하려면 UI 재실행이 필요합니다."
L["Uses SexyMap for the minimap."] = "미니맵에 SexyMap을 사용합니다."
L["Uses DuckcraftUI for the minimap."] = "미니맵에 DuckcraftUI를 사용합니다."
L["SexyMap visuals with DuckcraftUI editor and positioning."] = "SexyMap 외형을 사용하면서 DuckcraftUI 편집기와 위치 조정을 유지합니다."
...
L["Ignore"] = "무시"
L["Skip"] = "건너뛰기"
L["The Blizzard option |cFFFFFF00Party/Arena Background|r is enabled. This conflicts with DuckcraftUI's party frames."] = "블리자드 옵션 |cFFFFFF00파티/투기장 배경|r이 활성화되어 있습니다. DuckcraftUI 파티 프레임과 충돌합니다."
L["Disable it now?"] = "지금 비활성화하시겠습니까?"
L["Some interface settings are not configured optimally for DuckcraftUI."] = "일부 인터페이스 설정이 DuckcraftUI에 최적으로 맞춰져 있지 않습니다."
L["This includes settings that conflict with DuckcraftUI and settings recommended for the best visual experience."] = "여기에는 DuckcraftUI와 충돌하는 설정과 최상의 시각적 경험을 위해 권장되는 설정이 포함됩니다."
L["Affected settings:"] = "영향받는 설정:"
L["Some interface settings are not configured optimally for DuckcraftUI. Do you want to fix them?"] = "일부 인터페이스 설정이 DuckcraftUI에 최적으로 맞춰져 있지 않습니다. 지금 수정하시겠습니까?"
...
L["/duckcraftui debug on|off|status - Toggle diagnostic logging"] = "/duckcraftui debug on|off|status - 진단 로그 전환"
L["Usage: /duckcraftui debug on|off|status"] = "사용법: /duckcraftui debug on|off|status"
L["Enable debug mode first with /duckcraftui debug on"] = "먼저 /duckcraftui debug on 으로 디버그 모드를 활성화하세요"
