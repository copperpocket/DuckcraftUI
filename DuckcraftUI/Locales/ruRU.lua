...
local L = LibStub("AceLocale-3.0"):NewLocale("DuckcraftUI", "ruRU")
...
L["Commands: /duckcraftui config, /duckcraftui edit"] = "Команды: /duckcraftui config, /duckcraftui edit"
...
L["Error -- Addon 'DuckcraftUI_Options' not found or is disabled."] = "Ошибка — Аддон 'DuckcraftUI_Options' не найден или отключён."
...
L["=== DuckcraftUI Commands ==="] = "=== Команды DuckcraftUI ==="
L["/duckcraftui or /dui - Open configuration"] = "/duckcraftui или /dui — Открыть настройки"
L["/duckcraftui config - Open configuration"] = "/duckcraftui config — Открыть настройки"
L["/duckcraftui edit - Toggle editor mode (move UI elements)"] = "/duckcraftui edit — Переключить режим редактора (перемещение элементов)"
L["/duckcraftui reset - Reset all positions to defaults"] = "/duckcraftui reset — Сбросить все позиции по умолчанию"
L["/duckcraftui reset <name> - Reset specific mover"] = "/duckcraftui reset <имя> — Сбросить конкретный элемент"
L["/duckcraftui status - Show module status"] = "/duckcraftui status — Показать статус модулей"
L["/duckcraftui kb - Toggle keybind mode"] = "/duckcraftui kb — Переключить режим назначения клавиш"
L["/duckcraftui version - Show version info"] = "/duckcraftui version — Показать версию"
L["/duckcraftui help - Show this help"] = "/duckcraftui help — Показать справку"
...
L["=== DuckcraftUI Status ==="] = "=== Статус DuckcraftUI ==="
...
L["DuckcraftUI Version: "] = "Версия DuckcraftUI: "
L["Use /duckcraftui edit to enter edit mode, then right-click frames to reset."] = "Используйте /duckcraftui edit для входа в режим редактора, ПКМ по фрейму для сброса."
...
L["DuckcraftUI: Minimap module restored to Blizzard defaults"] = "DuckcraftUI: Модуль миникарты восстановлен до стандартных настроек Blizzard"
...
L["DuckcraftUI Conflict Warning"] = "DuckcraftUI — Предупреждение о конфликте"
L["The addon |cFFFFFF00%s|r conflicts with DuckcraftUI."] = "Аддон |cFFFFFF00%s|r конфликтует с DuckcraftUI."
L["Reason:"] = "Причина:"
L["Disable the conflicting addon now?"] = "Отключить конфликтующий аддон сейчас?"
L["Keep Both"] = "Оставить оба"
L["DuckcraftUI - D3D9Ex Warning"] = "DuckcraftUI — Предупреждение о D3D9Ex"
L["DuckcraftUI detected that your client is using D3D9Ex."] = "DuckcraftUI обнаружил, что ваш клиент использует D3D9Ex."
L["DuckcraftUI's action bar system is not compatible with D3D9Ex."] = "Система панелей действий DuckcraftUI несовместима с D3D9Ex."
L["Some DuckcraftUI action bar textures will be missing while this mode is active."] = "Пока этот режим активен, часть текстур панелей действий DuckcraftUI будет отсутствовать."
...
L["DuckcraftUI - UnitFrameLayers Detected"] = "DuckcraftUI — Обнаружен UnitFrameLayers"
L["DuckcraftUI already includes Unit Frame Layers functionality (heal prediction, absorb shields, and animated health loss)."] = "DuckcraftUI уже включает функциональность Unit Frame Layers (предсказание исцеления, щиты поглощения и анимация потери здоровья)."
L["Choose how to resolve this overlap:"] = "Выберите, как разрешить это пересечение:"
L["Use DuckcraftUI: disable external UnitFrameLayers and enable DuckcraftUI layers."] = "Использовать DuckcraftUI: отключить внешний UnitFrameLayers и включить слои DuckcraftUI."
L["Disable Both: disable external UnitFrameLayers and keep DuckcraftUI layers disabled."] = "Отключить оба: отключить внешний UnitFrameLayers и оставить слои DuckcraftUI выключенными."
L["Use DuckcraftUI"] = "Использовать DuckcraftUI"
L["Disable Both"] = "Отключить оба"
L["Use DuckcraftUI Unit Frame Layers"] = "Использовать слои фреймов DuckcraftUI"
...
-- Conflict reasons
L["Conflicts with DuckcraftUI's custom unit frame textures and power bar system."] = "Конфликтует с пользовательскими текстурами фреймов и системой полос ресурсов DuckcraftUI."
L["Known taint issues when manipulating party frames during combat. DuckcraftUI provides automatic fixes."] = "Известные проблемы с taint при изменении фреймов группы в бою. DuckcraftUI применяет автоматические исправления."
L["Resets minimap mask and blip textures. DuckcraftUI re-applies its custom textures automatically."] = "Сбрасывает маску и текстуры миникарты. DuckcraftUI автоматически восстанавливает свои текстуры."
L["SexyMap modifies the minimap borders, shape, and zone text which conflicts with DuckcraftUI's minimap module."] = "SexyMap изменяет границы, форму и текст зоны миникарты, что конфликтует с модулем миникарты DuckcraftUI."

-- SexyMap compatibility popup
L["DuckcraftUI - SexyMap Detected"] = "DuckcraftUI — Обнаружен SexyMap"
...
L["Choose how DuckcraftUI and SexyMap share the minimap."] = "Выберите, как DuckcraftUI и SexyMap делят миникарту."
...
L["Uses DuckcraftUI for the minimap."] = "Использовать DuckcraftUI для миникарты."
L["SexyMap visuals with DuckcraftUI editor and positioning."] = "Визуал SexyMap с редактором и позиционированием DuckcraftUI."
...
L["Skip"] = "Пропустить"
L["The Blizzard option |cFFFFFF00Party/Arena Background|r is enabled. This conflicts with DuckcraftUI's party frames."] = "Опция Blizzard |cFFFFFF00Фон группы/арены|r включена. Это конфликтует с фреймами группы DuckcraftUI."
L["Disable it now?"] = "Отключить сейчас?"
L["Some interface settings are not configured optimally for DuckcraftUI."] = "Некоторые настройки интерфейса настроены не оптимально для DuckcraftUI."
L["This includes settings that conflict with DuckcraftUI and settings recommended for the best visual experience."] = "Сюда входят настройки, конфликтующие с DuckcraftUI, а также рекомендуемые настройки для лучшего визуального восприятия."
L["Affected settings:"] = "Затронутые настройки:"
L["Some interface settings are not configured optimally for DuckcraftUI. Do you want to fix them?"] = "Некоторые настройки интерфейса настроены не оптимально для DuckcraftUI. Исправить их?"
...
L["/duckcraftui debug on|off|status - Toggle diagnostic logging"] = "/duckcraftui debug on|off|status — Переключить диагностическое логирование"
L["Usage: /duckcraftui debug on|off|status"] = "Использование: /duckcraftui debug on|off|status"
L["Enable debug mode first with /duckcraftui debug on"] = "Сначала включите режим отладки: /duckcraftui debug on"
