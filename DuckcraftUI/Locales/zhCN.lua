--[[
 DuckcraftUI - Simplified Chinese Locale (zhCN)
...
local L = LibStub("AceLocale-3.0"):NewLocale("DuckcraftUI", "zhCN")
...
L["DuckcraftUI detected that your client is using D3D9Ex."] = "DuckcraftUI 检测到你的客户端正在使用 D3D9Ex。"
L["DuckcraftUI's action bar system is not compatible with D3D9Ex."] = "DuckcraftUI 的动作条系统与 D3D9Ex 不兼容。"
L["Some DuckcraftUI action bar textures will be missing while this mode is active."] = "启用此模式后，部分 DuckcraftUI 动作条纹理将不会显示。"
